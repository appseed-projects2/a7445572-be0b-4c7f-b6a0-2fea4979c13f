...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-11-11 18:31`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a7445572-be0b-4c7f-b6a0-2fea4979c13f.git
$ cd a7445572-be0b-4c7f-b6a0-2fea4979c13f
```
